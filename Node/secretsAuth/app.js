...
async function run() {
  try {
    ...
    secretCollection = database.collection('secrets');
    ...
    const insertManyResult = await secretCollection.insertOne(adminUser);
...
app.post('/register', async function(req, res) {
    ...
    bcrypt.hash(req.body.password, saltRounds, function(err, hash) {
        ...
        secretCollection.insertOne(newUser);
...
app.post('/login', async function (req, res) {
    try {
        ...
        const userResult = await secretCollection.findOne({email: username});
